...
class PeriodicTaskAdmin(admin.ModelAdmin):
    ...
    list_display = ('name', 'enabled', 'scheduler', 'interval', 'start_time',
                    'last_run_at', 'one_off')
    list_filter = ['enabled', 'task', 'start_time', 'last_run_at']
    ...
    fieldsets = (
        ...
        ('Agenda', {
            'fields': ('crontab', 'crontab_translation',
                       'start_time', 'last_run_at', 'one_off'),
            'classes': ('extrapretty', 'wide', 'navtab'),
        }),
        ('Argumentos', {
            'fields': ('args', 'kwargs'),
            'classes': ('extrapretty', 'wide', 'navtab', 'in'),
        }),
        ('Opções de Execução', {
