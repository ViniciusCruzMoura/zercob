...
class LogEntryAdminMixin:
    ...
    @admin.display(description=_("Criado"))
    ...
    @admin.display(description=_("Recurso"))
    ...
    @admin.display(description=_("Alterações"))
    def msg_short(self, obj):
        ...
        return "%d %s: %s" % (len(changes), 'atualizações' if len(changes) != 1 else 'atualização', fields)
    ...
    def msg(self, obj):
        ...
        if atom_changes:
            msg.append("<table>")
            msg.append(self._format_header("#", "Campo", "De", "Para"))
